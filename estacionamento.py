...
vg = vp = vc = 40
veiculos = [
    {"placa": "ABC123", "modelo": "ONIX", "perfil": "ALUNO", "cor": "PRATA"},
    {"placa": "DEF456", "modelo": "HB20", "perfil": "ALUNO", "cor": "BRANCO"},
    {"placa": "GHI789", "modelo": "ARGO", "perfil": "ALUNO", "cor": "PRETO"},
    {"placa": "JKL012", "modelo": "GOL", "perfil": "ALUNO", "cor": "VERMELHO"},
    {"placa": "MNO345", "modelo": "COROLLA", "perfil": "COLABORADOR", "cor": "CINZA"},
    {"placa": "PQR678", "modelo": "CIVIC", "perfil": "COLABORADOR", "cor": "AZUL"},
    {"placa": "STU901", "modelo": "CRONOS", "perfil": "COLABORADOR", "cor": "BRANCO"},
    {"placa": "VWX234", "modelo": "TRACKER", "perfil": "COLABORADOR", "cor": "PRETO"},
    {"placa": "YZA567", "modelo": "COMPASS", "perfil": "PROFESSOR", "cor": "PRATA"},
    {"placa": "BCD890", "modelo": "T-CROSS", "perfil": "PROFESSOR", "cor": "CINZA"},
    {"placa": "EFG135", "modelo": "HR-V", "perfil": "PROFESSOR", "cor": "BRANCO"},
    {"placa": "HIJ246", "modelo": "CRETA", "perfil": "PROFESSOR", "cor": "AZUL"},
]
alunoestacionamento = [
...
while True:
    ...
    if op == 6:
        placa = input("Digite a placa do veículo: ").upper()
        local = input(
            "Digite o local de estacionamento (professor, colaborador, geral): "
        ).upper()
        ...
        if local == "PROFESSOR" or local == "COLABORADOR" or local == "GERAL":
            ...
            if autorizado == False:
                print(
                    "Veículo não registrado. Por favor, registre o veículo antes de registrar a entrada.\n"
                )
        else:
    ...
    if op == 7:
        local = input(
            "Digite o tipo de estacionamento (professor, colaborador, geral): "
        ).upper()
